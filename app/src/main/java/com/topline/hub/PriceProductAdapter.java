...
public class PriceProductAdapter extends RecyclerView.Adapter<PriceProductAdapter.MyViewHolder> {

    private List<PriceProduct_model> products;
    private Context context;

    public PriceProductAdapter(List<PriceProduct_model> products, Context context) {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.price_product_list, parent, false);
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
     ...
     private void openDetailActivity(String product_id,String product_name, String product_code){
        ...
        Intent i = new Intent(context, MyPriceActivity.class);
