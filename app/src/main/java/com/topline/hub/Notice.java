...
public class Notice extends AppCompatActivity {
    ...
    private void loadOutlets() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_NOTICE+user_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            OutletAdapter adapter = new OutletAdapter(Notice.this, outletList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Notice.this, "Error Loading Outlets Try again", Toast.LENGTH_SHORT).show();
