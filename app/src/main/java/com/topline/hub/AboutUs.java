...
public class AboutUs extends AppCompatActivity {
    ...
    private void loadOutlets() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_ABOUT+user_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            OutletAdapter adapter = new OutletAdapter(AboutUs.this, outletList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(AboutUs.this, "Error Loading Outlets Try again", Toast.LENGTH_SHORT).show();
