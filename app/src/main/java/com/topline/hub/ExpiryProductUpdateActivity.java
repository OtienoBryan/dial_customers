...
public class ExpiryProductUpdateActivity extends AppCompatActivity {
    ...
    TextView outletName;
    EditText productName,productCode,batchNo,quantity,expiryDate,comments,edtQty;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cd = new ConnectionDetector(ExpiryProductUpdateActivity.this);
        ...
        updateProduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cd.isConnectingToInternet()) {
                    ...
                    Toast.makeText(ExpiryProductUpdateActivity.this, "No Internet Connection !", Toast.LENGTH_LONG).show();
                }
                //UpdateExpiryTracker();
            }
        });
    ...
    private void UpdateExpiryTracker(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                Constants.URL_PRODUCT_EXPIRY_REPORT_UPDATE,
...
//                        CompetitiveActivity.this.finish();
                        ...
                        AlertDialog alertDialog = new AlertDialog.Builder(
                                ExpiryProductUpdateActivity.this).create();

                        // Setting Dialog Title
                        alertDialog.setTitle("Success !");

                        // Setting Dialog Message
                        alertDialog.setMessage("Activity Tracker Successfully Submitted");
                        ...
                        alertDialog.setButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent intent = new Intent(ExpiryProductUpdateActivity.this, ActivityTrackerView.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.hide();
                        Toast.makeText(ExpiryProductUpdateActivity.this, "Error Occurred Try again", Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
