    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Checkout.this, ProductCat.class));
            }
        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_COMPLETE,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            CartAdapter adapter = new CartAdapter(Checkout.this, cats);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Checkout.this, "Error Loading Product Category Try again", Toast.LENGTH_SHORT).show();
