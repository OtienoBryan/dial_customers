...
public class TeamLeaderCollage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_team_leader_collage);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        SharedPrefManager.getInstance(TeamLeaderCollage.this).removeMpa();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TeamLeaderCollage.this, MainActivity.class);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (!obj.getBoolean("error")){
                                ...
                                Toast.makeText(
                                        TeamLeaderCollage.this,
                                        obj.getString("message"),
                                        Toast.LENGTH_LONG
                                ).show();

                                SharedPrefManager.getInstance(TeamLeaderCollage.this).doneMPA();
...
//                        startActivity(new Intent(QuestionsActivity.this, MainActivity.class));
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentTeamleaderObjective(TeamLeaderCollage.this), "Weekly Action Log");
        //adapter.addFragment(new FragmentTeamleaderChecklist(TeamLeaderCollage.this), "Checklistnn");
