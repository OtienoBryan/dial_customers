...
public class GiftPack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_to_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(GiftPack.this, MainActivity.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_GIFT+category_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(GiftPack.this, cats);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(GiftPack.this, "Error Loading Product Category Try again", Toast.LENGTH_SHORT).show();
