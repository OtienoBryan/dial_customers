...
public class Wines extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(Wines.this, Manifest.permission.CALL_PHONE)
                != PackageManager.PERMISSION_GRANTED) {
            // Permission is not granted
            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) Wines.this,
                ...
                ActivityCompat.requestPermissions((Activity) Wines.this,
        ...
        back_to_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Wines.this, MainActivity.class));
            }
        });
        ...
        lnCat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Wines.this, WineCategory.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_WINE_COLOR+category_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(Wines.this, cats);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Wines.this, "Error Loading Product Category Try again", Toast.LENGTH_SHORT).show();
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.ses) {
            startActivity(new Intent(Wines.this, ExpiryProductListActivity.class));
    ...
    public void call(){
        ...
        if (ActivityCompat.checkSelfPermission(Wines.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {

            //ActivityCompat.requestPermissions(context, new String[] { permission }, requestCode);

            Toast.makeText(Wines.this, "Enable call permission in APP Settings", Toast.LENGTH_SHORT).show();
