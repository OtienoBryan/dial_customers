...
//getSupportActionBar().setHomeButtonEnabled(true);
        ...
        progressDialog.setMessage("Sending Asset Reports..");
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String adminId = SharedPrefManager.getInstance(AssetTrackerActivity.this).getUserUnit().trim();
                ...
                final String server_url="https://impulsepromotions.co.ke/bidco/mobile/v1/asset_report.php"; // url of server check this 100 times it must be working
                ...
                StringRequest stringRequest=new StringRequest(Request.Method.POST, server_url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                Toast.makeText(AssetTrackerActivity.this, "Asset Tracker Saved Successfully", Toast.LENGTH_LONG).show();

                                startActivity(new Intent(AssetTrackerActivity.this, QuestionsActivity.class));
                                AssetTrackerActivity.this.finish();
                            }
                        },
                ...
                Volley.newRequestQueue(AssetTrackerActivity.this).add(stringRequest);
    ...
    private void loadAssets() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_ASSETS+admin_id,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            AssetAdapter adapter = new AssetAdapter(AssetTrackerActivity.this, assets);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(AssetTrackerActivity.this, "Error Loading Assets Try again", Toast.LENGTH_SHORT).show();
