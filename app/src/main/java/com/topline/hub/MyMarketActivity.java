...
public class MyMarketActivity extends AppCompatActivity {
    ...
    TextView outlet, expiry_date,imple_date;
    EditText activity,impact, comments;
    Button uploadReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imple_date = (TextView) findViewById(R.id.imple_date);
        comments = (EditText)findViewById(R.id.comments);

        outlet.setText(product_name +"  In  "+ outlet_name);


        cd = new ConnectionDetector(MyMarketActivity.this);
        ...
        uploadReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cd.isConnectingToInternet()) {
                    if(imple_date.getText().toString().trim().equalsIgnoreCase("") || activity.getText().toString().trim().equalsIgnoreCase("") || impact.getText().toString().trim().equalsIgnoreCase("") ||comments.getText().toString().trim().equalsIgnoreCase("")){
                        Toast.makeText(MyMarketActivity.this, "All Fields are Required", Toast.LENGTH_SHORT).show();
                    }else {
                        submitExpiryTracker();
                    }

                } else {
                    Toast.makeText(MyMarketActivity.this, "No Internet Connection !", Toast.LENGTH_LONG).show();
                }
            }
        });

        imple_date.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                DatePickerDialog.OnDateSetListener date = new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear,
                        ...
                        imple_date.setText(sdf.format(myCalendar.getTime()));
                ...
                new DatePickerDialog(MyMarketActivity.this, date, myCalendar
    ...
    private void submitExpiryTracker(){
        ...
        final String e_activity = activity.getText().toString().trim();
        final String e_impact = impact.getText().toString().trim();
        final String e_comment = comments.getText().toString().trim();
        final String e_imple_date = imple_date.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                Constants.URL_MARKET_REPORT,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        progressDialog.dismiss();

                        Toast.makeText(MyMarketActivity.this, "Report Submitted Successfully", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(MyMarketActivity.this, QuestionsActivity.class));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.hide();
                        Toast.makeText(MyMarketActivity.this, "Error Occurred Try again", Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("activity", e_activity);
                params.put("impact", e_impact);
                params.put("imple_date", e_imple_date);
