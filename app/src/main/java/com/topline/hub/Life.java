...
public class Life extends AppCompatActivity {
    ...
    private void loadOutlets() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_LIFE+user_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            OutletAdapter adapter = new OutletAdapter(Life.this, outletList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Life.this, "Error Loading Outlets Try again", Toast.LENGTH_SHORT).show();
