...
public class MySosViewAdapter extends RecyclerView.Adapter<MySosViewAdapter.MyViewHolder> {

    private List<MySosView_model> expiries;
    private Context context;

    public MySosViewAdapter(List<MySosView_model> expiries, Context context) {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_my_sos_view_adapter, parent, false);
