...
public class ProductCategoryActivity extends AppCompatActivity {
    ...
    private void loadCategories() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_PRODUCT_CATEGORY+admin_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ProductCatAdapter adapter = new ProductCatAdapter(ProductCategoryActivity.this, cats);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(ProductCategoryActivity.this, "Error Loading Product Category Try again", Toast.LENGTH_SHORT).show();
