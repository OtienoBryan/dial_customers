...
public class MarketProductAdapter extends RecyclerView.Adapter<MarketProductAdapter.MyViewHolder> {
    ...
    public MarketProductAdapter(List<QualityProduct_model> products, Context context) {
    ...
    public MyViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_market_product_adapter, parent, false);
    ...
    private void openDetailActivity(String product_id,String product_name, String product_code){
        ...
        Intent i = new Intent(context, MyMarketActivity.class);
