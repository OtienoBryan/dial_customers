 ...
 */
public class Fragment_Coaching extends Fragment {
    ...
    public Fragment_Coaching(Context context) {
        this.context = context;
    }

    public Fragment_Coaching() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.activity_fragment__coaching, container, false);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(edtObjective.getText().toString().equalsIgnoreCase("")){
                    Toast.makeText(context, "Activity is required", Toast.LENGTH_SHORT).show();
                    ...
                    if(edtChallenge.getText().toString().equalsIgnoreCase("") || edtPlan.getText().toString().equalsIgnoreCase("")){
                        Toast.makeText(context, "Enter the challenge", Toast.LENGTH_SHORT).show();
                    }else{
                        submitObjective();
                    }
                }else {
