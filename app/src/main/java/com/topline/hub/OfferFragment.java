...
public class OfferFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offer_fragment);
        ...
        back_to_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(OfferFragment.this, MainActivity.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_MY_OFFERS+category_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ProductAdapter adapter = new ProductAdapter(OfferFragment.this, cats);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(OfferFragment.this, "Error Loading Product Category Try again", Toast.LENGTH_SHORT).show();
