...
public class Mental extends AppCompatActivity {
    ...
    private void loadOutlets() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constants.URL_MENTAL+user_id,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            OutletAdapter adapter = new OutletAdapter(Mental.this, outletList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(Mental.this, "Error Loading Outlets Try again", Toast.LENGTH_SHORT).show();
